...
$stmt = $conn->prepare("INSERT IGNORE INTO saved_recipes (user_id, recipe_id, recipe_name, recipe_thumb, recipe_category) VALUES (?, ?, ?, ?, ?)");
$stmt->bind_param("issss", $user_id, $recipe_id, $recipe_name, $recipe_thumb, $recipe_category);
